...
class Ravi{
    ...
    vector<vector<string>> technical_background = [["Python", "C++", "C"],["HTML", "CSS", "Java Script"],
                                   ["MongoDB", "Express", "React", "NodeJs"], ["numpy", "pandas", "matplotplib"]];
    vector<string> projects = [ "ChatAPP", "Student Search IIT Kanpur clone", "toDO", "iChat", "TreeMap"];
